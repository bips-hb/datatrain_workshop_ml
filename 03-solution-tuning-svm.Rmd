...
We'll use `{mlr3}`'s [`AutoTuner`](https://mlr3book.mlr-org.com/optimization.html#autotuner) for this because it's just so convenient:
...
## Bonus feature: Benchmarking all the things (with tuning)
