...
# Since it's a relatively large task and some of these methods take some time, we downsample the dataset by 60% --- feel free to comment this out at home when you have the time.
bikeshare$filter(partition(bikeshare, 0.6)$train)
