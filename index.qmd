...
```{r}
library(mlr3verse)
rr <- resample(tsk("sonar"), lrn("classif.ranger", predict_type = "prob"), rsmp("cv", folds = 3))
...
1. Install R packages required for the workshop by opening the workshop repository in RStudio (e.g. double-clicking the `datatrain_workshop_ml.Rproj` file)  
...
packages <- c(
  ...
  "rpart.plot", "jemus42/xplainfi", "effectplots",
